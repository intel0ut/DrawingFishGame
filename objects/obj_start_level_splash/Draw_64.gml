...
if SPLASH {
	...
	draw_text_ext_transformed_color(room_width/3-100, room_height/2-50, _lvl,0,room_width,3,2,0, c_teal, c_teal, c_blue, c_blue, alpha)
}
...
if !SPLASH {
	...
	alpha = sin( expired/duration * 3.14159 );   // ramps up and down
	y-=1; 
	draw_text_ext_transformed_color(room_width/3-50, room_height/2-50, "S T A R T",0,room_width,3,2,0, c_teal, c_teal, c_blue, c_blue, alpha)
}